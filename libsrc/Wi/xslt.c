...
dict_put_impl (id_hash_iterator_t *hit, caddr_t key, caddr_t val, int signal_unsafe_args)
{
  ...
  if (NULL != old_val_ptr)
    ...
    {
      if (signal_unsafe_args && wrlocked)
	{
